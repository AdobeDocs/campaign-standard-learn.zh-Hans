...
+ [Adobe Campaign Standard 教程](/help/overview.md)
+ 快速入门 {#getting-started}
   ...
   + [了解轮廓和受众](/help/getting-started/understanding-profiles-and-audiences.md)
...
+ 通信渠道 {#communication-channels}
   + 电子邮件 {#email}
      ...
      + [使用目标轮廓测试电子邮件消息](/help/communication-channels/email/profile-substitution.md)
   ...
   + 移动设备 {#mobile}
      ...
      + 应用程序内消息 {#in-app}
         ...
         + [基于其 Campaign 轮廓的目标用户](/help/communication-channels/mobile/in-app/target-users-based-on-campaign-profile.md)
...
+ 报告和监测 {#reporting}
   ...
   + [根据自定义轮廓属性创建报告](/help/reporting/custom-profile-attributes-dynamic-reports.md)
